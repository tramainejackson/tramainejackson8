    ...
    <div class="streak1">
        <div class="flex-center">
            <ul class="list-unstyled">
                <li><h2 class="h2-responsive mt-5 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">Want
                        an outstanding project?</h2></li>
                <li><h5 class="h5-responsive wow fadeIn" data-wow-delay="0.2s"
                        style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">Just send me a
                        message!</h5></li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-auto mx-auto">
            ...
            <section id="contact" class="section pb-5 wow fadeIn" data-wow-delay="0.3s"
                ...
                <!-- Section heading -->
                <h2 class="section-heading h1 pt-4 pb-3 text-center">Contact Me</h2>
                    ...
                    <div class="col-12">
                        <ul class="contact-icons">
                            <li><i class="fa fa-map-marker fa-2x"></i>
                                <p class="d-inline-block pl-3">Philadelphia, PA 19140, USA</p>
                            </li>

                            <li><i class="fa fa-phone fa-2x"></i>
                                <p class="d-inline-block pl-3">+ 1 {{ $setting->phone }}</p>
                            </li>

                            <li><i class="fa fa-envelope fa-2x"></i>
                                <p class="d-inline-block pl-3"><a href="mailto:{{ $setting->email }}">{{ $setting->email }}</a></p>
                            </li>

                            <li><i class="fab fa-linkedin fa-2x"></i>
                                <p class="d-inline-block pl-3"><a href="https://www.linkedin.com/in/tramaine-jackson/">LinkedIn/Tramaine Jackson</a></p>
                            </li>

                            <li><i class="fab fa-github fa-2x"></i>
                                <p class="d-inline-block pl-3"><a href="https://github.com/tramainejackson">Github/Tramaine Jackson</a></p>
                            </li>
                        </ul>
                    </div>
                    <!-- Grid column -->
