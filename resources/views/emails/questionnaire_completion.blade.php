														...
														<tr style="border-collapse:collapse;">
															<td width="560" valign="top" align="center" style="padding:0;Margin:0;">
																<table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
																	<tbody>
																		<tr style="border-collapse:collapse;">
																			<td align="left" style="padding:0;Margin:0;padding-bottom:15px;"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#333333; text-align: center">Questionnaire Completion</h2></td>
																		</tr>
																		<tr style="border-collapse:collapse;">
																			<td align="left" style="padding:0;Margin:0;padding-top:20px;">
																				@php $display_date = date_create($questionnaire->projected_due_date); @endphp
																				...
																				<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">
																					<span style="font-weight: 600;">Owner Name</span>&nbsp;&nbsp;{{ $questionnaire->owner }}
																					<br/><span style="font-weight: 600;">Owner Email:</span>&nbsp;{{ $questionnaire->owner_email }}
																					<br/><span style="font-weight: 600;">Amount Due:</span>&nbsp;${{ $questionnaire->total_cost }}
																					<br/><span style="font-weight: 600;">Projected Due Date:</span>&nbsp;{{ date_format($display_date, 'm/d/Y') }}
																				</p>
																			</td>
																		</tr>
																	</tbody>
