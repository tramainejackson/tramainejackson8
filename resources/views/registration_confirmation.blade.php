                    ...
                    <div class="col-12 text-center text-white font8" id="">
                        ...
                        <div class="col-12 text-center text-white font8 my-3">
                            <p class=""><span class="fw-bold text-decoration-underline">Cost & Includes</span>:&nbsp
                                ...
                                Please complete the registration form if you want to add a parent to the tour. Once
                                payment is received for the tour, your spot/seat will be locked in.</p>
                        </div>
                ...
                @else
                    ...
                    <div class="col-12 text-center text-white font8 my-3">
                        <p class=""><span class="fw-bold text-decoration-underline">Cost & Includes</span>:&nbsp
                            <br/>Cost is $150 per person. There are limited spots on the bus.
                            Trip cost includes charter bus ride to and from all
                            universities and an overnight stay in a hotel in Virginia. Once payment is received for the
                            tour, your spot/seat will be locked in.</p>
                    </div>
