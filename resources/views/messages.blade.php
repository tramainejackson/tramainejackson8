                        ...
                        <div class="col" id="">
                            ...
                            <div class="card" id="">
                                ...
                                <div class="card-body" id="">
                                    ...
                                    <div class="" id="">
                                        <h3 class="card-title"><span class="font-weight-bold">Name: </span>{{ $message->name }} </h3>
                                    </div>

                                    <div class="" id="">
                                        <p class="card-text"><span class="font-weight-bold">Received: </span>{{ $message->created_at->format('m/d/Y') }} </p>
                                        <p class="card-text"><span class="font-weight-bold">Email Address: </span>{{ $message->email }}</p>
                                        <p class="card-text"><span class="font-weight-bold">Subject: </span>{{ str_ireplace(';', ', ', $message->reason) }}</p>
